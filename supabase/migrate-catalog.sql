...
insert into public.catalog_services (
  ...
  ('radio', 'face', 'Θεραπείες προσώπου', 'Ραδιοσυχνότητες', 45, 5000, false, false, 410, true),
  ...
  ('lw-full-10', 'laser-women', 'Αποτρίχωση Laser — Γυναίκες', 'Laser Full Body — 10 συνεδρίες', 60, 115000, false, false, 580, true),
  ('lw-full-6', 'laser-women', 'Αποτρίχωση Laser — Γυναίκες', 'Laser Full Body — 6 συνεδρίες', 60, 69000, false, false, 590, true),
  ('lw-bikini-under-6', 'laser-women', 'Αποτρίχωση Laser — Γυναίκες', 'Laser Full Bikini + Armpits — 6 συνεδρίες', 20, 30000, false, false, 600, true),
  ('lw-bikini-under-10', 'laser-women', 'Αποτρίχωση Laser — Γυναίκες', 'Laser Full Bikini + Armpits — 10 συνεδρίες', 20, 50000, false, false, 610, true),
