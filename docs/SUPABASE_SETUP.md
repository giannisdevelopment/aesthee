...
6. Authentication → URL Configuration → Site URL = `https://www.aesthee.gr`
7. Add Redirect URL: `https://www.aesthee.gr/**` (optional: also keep `https://aesthee.vercel.app/**` for previews)
...
2. In Vercel → Project → Settings → Environment Variables add:
   ...
   - optional `SITE_URL` = `https://www.aesthee.gr`
3. Redeploy
